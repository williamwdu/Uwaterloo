...
public final class Simulator_cse4 {
    public static void main(final String[] args) {
        ...
        for (int time = 0; time < timeCount; time++) {
            ...
            final String out_y = y(in_b, in_a, in_d, in_c) ? "1 " : "0 ";
            // store outputs
    ...
    public static boolean y(final boolean b, final boolean a, final boolean d, final boolean c) { return or(and(b, a) , and(d, c) ) ; }
}
