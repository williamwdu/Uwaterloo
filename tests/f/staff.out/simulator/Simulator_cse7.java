...
public final class Simulator_cse7 {
    public static void main(final String[] args) {
        ...
        for (int time = 0; time < timeCount; time++) {
            ...
            final String out_x = x(in_a, in_b, in_c) ? "1 " : "0 ";
            final String out_y = y(in_a, in_b) ? "1 " : "0 ";
            final String out_z = z(in_a, in_c) ? "1 " : "0 ";
            // store outputs
    ...
    public static boolean x(final boolean a, final boolean b, final boolean c) { return and(a, or(b, c) ) ; }
    public static boolean y(final boolean a, final boolean b) { return and(a, b) ; }
    public static boolean z(final boolean a, final boolean c) { return and(a, c) ; }
}
