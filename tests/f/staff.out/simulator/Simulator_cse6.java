...
public final class Simulator_cse6 {
    ...
    public static boolean x(final boolean a, final boolean b) { return or(not(a) , not(b) ) ; }
    public static boolean y(final boolean a, final boolean b) { return not(and(a, b) ) ; }
}
