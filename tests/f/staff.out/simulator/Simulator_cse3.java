...
public final class Simulator_cse3 {
    public static void main(final String[] args) {
        ...
        for (int time = 0; time < timeCount; time++) {
            ...
            final String out_y = y(in_a, in_b, in_e, in_f) ? "1 " : "0 ";
            // store outputs
    ...
    public static boolean y(final boolean a, final boolean b, final boolean e, final boolean f) { return or(and(a, b) , and(e, f) ) ; }
}
