...
public final class Simulator_cse2 {
    public static void main(final String[] args) {
        ...
        for (int time = 0; time < timeCount; time++) {
            ...
            final String out_y = y(in_a, in_b, in_c, in_d) ? "1 " : "0 ";
            // store outputs
    ...
    public static boolean y(final boolean a, final boolean b, final boolean c, final boolean d) { return or(and(a, b) , and(c, d) ) ; }
}
