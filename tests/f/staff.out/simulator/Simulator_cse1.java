...
public final class Simulator_cse1 {
    public static void main(final String[] args) {
        ...
        for (int time = 0; time < timeCount; time++) {
            ...
            final String out_x = x(in_d, in_a, in_b) ? "1 " : "0 ";
            final String out_y = y(in_e, in_a, in_b) ? "1 " : "0 ";
            // store outputs
    ...
    public static boolean x(final boolean d, final boolean a, final boolean b) { return and(d, or(a, b) ) ; }
    public static boolean y(final boolean e, final boolean a, final boolean b) { return and(e, or(a, b) ) ; }
}
